...
public class FilterDispatcher implements Filter {
    ...
    //private final String MAPPING_FILE = "data.txt";
    private final String MAPPING_FILE = "data.txt";
...
//    }
        ...
        //     context.setAttribute("LISTMAPPING", list);
        String uri = req.getRequestURI();
        int lastIndex = uri.lastIndexOf("/");
        String label = uri.substring(lastIndex + 1);

//        ResourceBundle bundle
//                = ResourceBundle.getBundle("uyennlp.properties.mappingProperties");
//        context.setAttribute("MAPPING", bundle);
        ResourceBundle bundle = (ResourceBundle) context.getAttribute("MAPPING");

//        if (bundle != null) {
//            String resource = bundle.getString(label);
//            if (resource == null) {
//                resource = START_APP_SERVLET;
//            }
